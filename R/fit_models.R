...
#' @param method Method to use. Currently the only option is "Ridge". This is mainly for compatability
...
#' @param ... Any othe parameters to pass to the underlying fitting function (in this case \code{\link{[greta]{mcmc}}})
#'
...
#'
#' @examples
phurl_fit_traits_continuous_bayesian <- function(x, method = c("Ridge"), regularise_first_split = FALSE, 
                                                 tree = NULL, n_samples = 1000, thin = 1,
